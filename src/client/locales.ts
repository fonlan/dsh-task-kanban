...
export const zh = {
  ...
  refresh: '刷新',
  settingsTitle: '任务看板',
  sectionSub: '全局并行 worker 数与各会话类型的默认模型、推理强度、Agent 预设',
...
export const en = {
  ...
  sectionSub: 'Global parallel workers and per-session-type defaults for model, reasoning effort, and agent preset',
