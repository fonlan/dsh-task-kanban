/**
 * tsdown build for @fonlan/dsh-task-kanban: the host-half lib (lib/index.js, ESM
 ...
 * with the package-name id `@fonlan/dsh-task-kanban` (the client-modules compose
...
export default [
  ...
  clientBundle('@fonlan/dsh-task-kanban', 'client.js'),
