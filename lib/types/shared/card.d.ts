...
export type CardStatus = 'draft' | 'refining' | 'planned' | 'queued' | 'running' | 'completed' | 'merging' | 'merged' | 'error';
/** Error kinds; each maps back to a resume action (retry/stop/delete). */
export type ErrorKind = 'refine_failed' | 'phase_failed' | 'interrupted' | 'merge_failed' | 'no_base_branch' | 'worktree_failed' | 'create_failed';
